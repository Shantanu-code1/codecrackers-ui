...
const Home = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-primary via-background to-primary/90 min-h-screen flex flex-col">
      ...
      <div className="py-6 sm:py-12 flex-grow">
        <PageContainer>
          {/* Hero Section */}
          <motion.div
          ...
          >
            ...
            <p className="mt-3 text-base sm:text-lg md:text-xl text-text-muted sm:mt-5 sm:max-w-xl mx-auto md:mt-5 px-2">
            ...
            <div className="mt-5 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:gap-0 sm:justify-center px-4">
              ...
              <div className="sm:ml-3 w-full sm:w-auto">
                <Button variant="outline" className="w-full sm:w-auto border-secondary text-secondary">
                  Learn More
                </Button>
              </div>
            </div>
          ...
          <motion.div className="max-w-5xl mx-auto mb-8 sm:mb-16 px-4 overflow-visible" initial="hidden" animate="visible" variants={staggerChildren}>
            <motion.h2 variants={fadeIn} className="text-2xl sm:text-3xl font-bold text-text text-center mb-6 sm:mb-8">
          ...
          <motion.div className="max-w-5xl mx-auto mb-8 sm:mb-16 px-4" initial="hidden" animate="visible" variants={fadeIn}>
            <h2 className="text-2xl sm:text-3xl font-bold text-[#E5E7EB] text-center mb-6 sm:mb-8">Why Choose Us?</h2>
            <div className="bg-[#161B22] rounded-lg shadow-xl overflow-hidden border border-[#30363D]">
              <div className="flex flex-col sm:flex-row border-b border-[#30363D]">
                <motion.button
                  className={`flex-1 py-3 sm:py-4 px-4 sm:px-6 text-sm font-medium transition-colors duration-300 ${
              ...
              <div className="p-4 sm:p-6">
                <AnimatePresence mode="wait">
                  {activeTab === "fast" && (
                    ...
                    >
                      <h3 className="text-lg sm:text-xl font-semibold mb-3 text-[#E5E7EB]">Lightning-Fast Doubt Resolution</h3>
                  ...
                  {activeTab === "ai" && (
                    <motion.div
                      ...
                      transition={{ duration: 0.2 }}
                    >
                      <h3 className="text-lg sm:text-xl font-semibold mb-3 text-[#E5E7EB]">Human Expertise + AI Efficiency</h3>
                      <p className="text-sm sm:text-base text-[#A1A1AA]">
          ...
          {/* AI Offering */}
          <motion.div className="max-w-5xl mx-auto mb-8 sm:mb-16 px-4" initial="hidden" animate="visible" variants={fadeIn}>
            <div className="bg-[#161B22] rounded-lg shadow-xl p-4 sm:p-8 text-[#E5E7EB] overflow-hidden relative border border-[#30363D]">
              <motion.div
              ...
              />
              <h2 className="text-xl sm:text-2xl font-bold mb-4 relative text-[#E5E7EB]">Our AI Advantage</h2>
              <p className="text-base sm:text-lg mb-6 relative text-[#A1A1AA]">
                Get access to our powerful AI doubt solver, free with your subscription!
              </p>
              <motion.div
                className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4 bg-[#0D1117] p-4 rounded-lg relative border border-[#30363D]"
                whileHover={{ scale: 1.01 }}
                transition={{ type: "spring", stiffness: 300 }}
              >
                <Bot className="h-6 w-6 sm:h-8 sm:w-8 text-[#0070F3] flex-shrink-0" />
                <div>
                  <span className="text-base sm:text-lg font-semibold text-[#E5E7EB] block">24/7 AI-powered assistance</span>
          ...
          <motion.div
            ...
            variants={fadeIn}
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-[#E5E7EB] mb-4">Start Your Learning Journey Today</h2>
            <p className="text-lg sm:text-xl text-[#A1A1AA] mb-6 sm:mb-8">Get your first query resolved absolutely free!</p>
            <motion.button
              className="bg-[#0070F3] hover:bg-[#0070F3]/90 text-white px-6 sm:px-8 py-3 rounded-full font-medium text-base sm:text-lg shadow-lg w-full sm:w-auto"
      ...
      <footer className="bg-[#0D1117] text-[#E5E7EB] py-6 sm:py-8 px-4 w-full relative">
          ...
          <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center space-y-6 md:space-y-0">
            ...
            <div className="w-full md:w-1/3 text-center">
              ...
              <ul className="text-sm space-y-1">
                <li>
                  <a href="#" className="text-[#A1A1AA] hover:text-[#0070F3] transition-colors">
                    About Us
                  </a>
                </li>
                <li>
